...
from src.widgets.quit import QuitScreen
from src.widgets.screens import MainScreen
from src.widgets.server_info import ServerInfoScreen
...
class JiraApp(App):
    ...
    async def action_help(self) -> None:
        from src.widgets.help import HelpScreen
