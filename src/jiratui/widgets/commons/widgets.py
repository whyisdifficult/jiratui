...
- [SprintWidget](#jiratui.widgets.commons.widgets.SprintWidget): text input field for providing the ID of a sprint using a shorter layout.
- [EpicLinkWidget](#jiratui.widgets.commons.widgets.: text input field for providing the key of an Epic issue using a shorter layout.
- [MultiUserPickerWidget](#jiratui.widgets.commons.widgets.MultiUserPickerWidget): comma-separated list of users.
- [SingleUserPickerWidget](#jiratui.widgets.commons.widgets.SingleUserPickerWidget): text input for providing a single Jira user.
- [PlainTextTextAreaWidget](#jiratui.widgets.commons.widgets.PlainTextTextAreaWidget): a TexArea widget that allows editing non-ADF text.
"""
